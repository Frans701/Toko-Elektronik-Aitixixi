          ...
          <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <div class="position-absolute bg-dark px-3 py-2 text-white"> <a class="text-white text-decoration-none" href="/posts?categories={{ $product->product_name }}">{{ $product->product_name }}</a></div>
                        <img src="https://source.unsplash.com/500x400?{{ $product->product_name }}" class="card-img-top" alt="">
                        <div class="card-body">
                          <div>
